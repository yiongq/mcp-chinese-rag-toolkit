...
Defined in: [packages/mcp-chinese-rag-toolkit/src/eval/ci-helper.ts:147](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/packages/mcp-chinese-rag-toolkit/src/eval/ci-helper.ts#L147)
