...
Defined in: [packages/mcp-chinese-rag-toolkit/src/rag/pdf-parser.ts:17](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/packages/mcp-chinese-rag-toolkit/src/rag/pdf-parser.ts#L17)
