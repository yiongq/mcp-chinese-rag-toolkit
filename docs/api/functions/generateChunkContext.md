...
Defined in: [packages/mcp-chinese-rag-toolkit/src/rag/contextual-retrieval.ts:71](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/packages/mcp-chinese-rag-toolkit/src/rag/contextual-retrieval.ts#L71)
