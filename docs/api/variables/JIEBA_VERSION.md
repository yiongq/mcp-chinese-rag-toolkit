...
Defined in: [packages/mcp-chinese-rag-toolkit/src/rag/tokenizer-meta.ts:16](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/packages/mcp-chinese-rag-toolkit/src/rag/tokenizer-meta.ts#L16)
