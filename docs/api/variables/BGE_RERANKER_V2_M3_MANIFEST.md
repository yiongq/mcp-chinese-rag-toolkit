...
Defined in: [packages/mcp-chinese-rag-toolkit/src/rag/model-manifest.ts:91](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/src/rag/model-manifest.ts#L91)
...
tag, 10k+ downloads, MIT licence inherited from BAAI). See 
...
exceeds 2GB which doubles the CI cache footprint vs 's "~568MB
...
MIRACL-zh, well within the  /  `rerankScore < 0.5` low-confidence
...
as the reranker output size. See Dev Notes §6
...
a new revision AND eval confirms no Hit Rate@5 regression —
