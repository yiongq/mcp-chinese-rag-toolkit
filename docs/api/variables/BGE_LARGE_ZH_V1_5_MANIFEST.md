...
Defined in: [packages/mcp-chinese-rag-toolkit/src/rag/model-manifest.ts:16](https://github.com/yiongq/mcp-chinese-rag-toolkit/blob/main/packages/mcp-chinese-rag-toolkit/src/rag/model-manifest.ts#L16)
